...
EnumLocal.txtLoginSubTitle.name: 
  ...
  EnumLocal.txtSubscriptionFee.name: "Set Subscription Fee in USD only",
  EnumLocal.txtIdentificationCode.name: "Kul CLass ID",
  ...
  EnumLocal.txtViewProfile.name: "View Channel",
  EnumLocal.txtViewDetails.name: "View Details",
  EnumLocal.txtFollow.name: "Subscribe",
  EnumLocal.txtFollowing.name: "Subscribed",
  EnumLocal.txtLikes.name: "Likes",
  EnumLocal.txtFollowers.name: "Subscribers",
  ...
  EnumLocal.txtRechargeCoin.name: "Deposit",
  EnumLocal.txtCoinHistory.name: "Transaction History (USD)",
  EnumLocal.txtWithdraw.name: "Withdraw",
  EnumLocal.txtAvailableCoin.name: "Available Balance",
  EnumLocal.txtEnterCoin.name: "Withdrawals to a local bank are allowed, but processing may take up to 7 days. You will receive the funds in your local currency. PayPal USD withdrawals are processed within 24 hours.",
  EnumLocal.txtEnterWithdrawCoin.name: "Enter Amount in USD...",
  ...
  EnumLocal.txtPurchasePremiumPlanAndGetAllAccess.name: "Purchase a Bundle & Get KulCoin + Benefits",
  EnumLocal.txtRechargePageSubTitle.name: "Get a KulCoin bundle for exclusive Kul Class coins and unlimited access to advanced tools. Elevate your experience now.",
  ...
  EnumLocal.txtPurchasePlan.name: "Purchase Bundle",
  EnumLocal.txtPayNow.name: "Pay Now",
  EnumLocal.txtMostPopularPlan.name: "Most Popular Bundle",
  ...
  EnumLocal.txtLoginSuccess.name: "Login Successful",
  ...
  EnumLocal.txtPleaseWaitSomeTime.name: "Please wait for sometime...",
  ...
  EnumLocal.txtPleaseEnterWithdrawCoin.name: "Please enter withdrawal amount !!",
  EnumLocal.txtPleaseSelectWithdrawMethod.name: "Please select withdrawal method !!",
  ...
  EnumLocal.txtWithdrawalRequestedCoinMustBeGreaterThanSpecifiedByTheAdmin.name: "Withdrawal amount must be greater than set minimum!!",
  EnumLocal.txtDownloadSuccess.name: "Download Successful",
  ...
  EnumLocal.txtPleaseUploadScreenShort.name: "Please upload screenshort !!",
  EnumLocal.txtYourComplainSendSuccessfully.name: "Your complain sent successfully",
  EnumLocal.txtCoinRechargeSuccess.name: "Recharge successful",
  ...
  EnumLocal.txtVerificationRequestSendSuccessfully.name: "Verification request sent successfully",
  ...
  EnumLocal.txtReceivedCoin.name: "Received",
  EnumLocal.txtSendCoin.name: "Sent",
  ...
  EnumLocal.txtTypeYourHashtag.name: "Type your hash tag...",
  EnumLocal.txtYouCantSendGiftOwnVideo.name: "You can't send gift to own video",
  EnumLocal.txtWelcomeBonusCoin.name: "Welcome Bonus",
  EnumLocal.txtSendGiftCoin.name: "Sent",
  EnumLocal.txtReceiveGiftCoin.name: "Received",
  EnumLocal.txtYouDonHaveSufficientCoinsToSendTheGift.name: "You don't have sufficient balance to send the gift !!",
  ...
  EnumLocal.txtSendCodeThisNumber.name: "send coin to this number",
  EnumLocal.txtResendCode.name: "Resend coin",
