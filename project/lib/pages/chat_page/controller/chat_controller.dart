...
import 'package:auralive/pages/chat_page/api/fetch_user_chat_api.dart';
import 'package:auralive/pages/chat_page/api/send_file_api.dart';
import 'package:auralive/pages/chat_page/model/fetch_user_chat_model.dart';
...
class ChatController extends GetxController {
  ...
  List<Chat> fakeChatData = [
    Chat(
      ...
      message: "Hello! Are you ready for today’s class?",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "Yes, I’m ready. What topic are we covering?",
      image: "",
      audio: "",
      isRead: false,
    ...
    Chat(
      ...
      message: "Let’s continue the lesson later today.",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "Sure, what time is the session scheduled?",
      image: "",
      audio: "",
      isRead: false,
    ...
    Chat(
      ...
      message: "Are you joining the live class?",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "Can you review the study material?",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "I’ll go through it and share my feedback.",
      image: "",
      audio: "",
      isRead: false,
    ...
    Chat(
      ...
      message: "Don’t forget to submit the assignment tomorrow.",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "Are we still on for the practice session tonight?",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "Can you share the lesson notes?",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "Sure, I’ll upload them shortly.",
      image: "",
      audio: "",
      isRead: false,
    ...
    Chat(
      ...
      message: "Please update the project document.",
      image: "",
      audio: "",
      isRead: true,
    ...
    Chat(
      ...
      message: "I’ll make the updates today.",
      image: "",
      audio: "",
      isRead: false,
